...
This repository demonstrates research judgment rather than deep-model promotion: a frozen scientific input, chronology-safe normalization, rolling-origin evaluation on common target dates, strong simple and nonlinear baselines, a compact Transformer with context-invariant trainable size and matched training budget, repeated seeds, per-seed all-baseline block-bootstrap comparisons, regime/era diagnostics and reproducible manuscript outputs.
